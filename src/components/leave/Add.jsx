...
const Add = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md'>
        <h2 className='text-2xl font-bold mb-6 text-black'>Request for Leave</h2>
        <form onSubmit={handleSubmit}>
            <div className='flex flex-col space-y-4'>
                ...
                <div>
                    ...
                    <textarea name="reason" placeholder='Reason' onChange={handleChange} className="w-full border border-gray-300"/>
                </div>
            </div>
